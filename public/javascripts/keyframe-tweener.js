...
var KeyframeTweener = {
    ...
    runToAbruptStop: function (currentTime, start, distance, duration) {
	    var tc = (currentTime/=duration)*currentTime*currentTime;
	    return start+distance*(tc);
    },
    
    // Also generated by Groleau's easing function generator
    fireFlickering: function (currentTime, start, distance, duration) {
        // JD: Indent...
	var ts = (currentTime/=duration)*currentTime;
	var tc = ts*currentTime;
	return start+distance*(63.795*tc*ts + -182.29*ts*ts + 187.795*tc + -83.3*ts + 15*currentTime);
    },
